...
datetime 到期時間=D'2189.03.08 15:17';
            ...
            if(FUN_COit0252(0)>0)
              {
               ...
               Li_FFE0 = OrderSend(_Symbol, OP_BUYSTOP, Ld_FFF0, Ask+iDist*Point, Ii_0E60, 0, 0, sPosComm+DoubleToStr(Ask+iDist*Point*2,Digits), Magic, 0, 16711680);
               if(Li_FFE0 == -1)
                 {
                  Print(923, "  ERR open Buy Order. Err: ", GetLastError());
                 }
               ...
               if(FUN_COit0252(1)>0)
                 {
                  ...
                  Li_FFE0 = OrderSend(_Symbol, OP_SELLSTOP, Ld_FFF0, Bid-iDist*Point, Ii_0E60, 0, 0, sPosComm+DoubleToStr(Bid-iDist*Point*2,Digits), Magic, 0, 255);
                  if(Li_FFE0 == -1)
                    {
                     Print(938, "  ERR open Sell Order. Err: ", GetLastError());
                    }
