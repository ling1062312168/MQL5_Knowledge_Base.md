...
//+------------------------------------------------------------------+
input group    "=== 自定义平仓设置 ==="
input ENUM_PROFIT_CLOSE_MODE InpProfitCloseMode = 单目标止盈; // 平仓模式（单目标/阶梯/回撤）
...
input ENUM_TRAILING_TYPE  InpTrailingType    = 固定间距;   // 止盈类型（固定/ATR/阶梯）
...
public:
   ...
   void BuildPanel()
   {
      ...
      // 标题区
      Rect("TitleBG", 0, 0, m_w, 78, C'35,30,25', C'100,80,40');
      Label("Title1", "金戈铁马  多核对冲量化引擎", 10, 4, 300, 22, C'200,180,120', 13);
      Label("Title2", "GOLDEN CAVALRY · MULTI-CORE HEDGE · ARES FLAGSHIP v2.1", 10, 28, 400, 12, C'150,130,80', 8);
      Label("Title3", "「 金戈所向·多空俱亡  |  铁马奔腾·对冲千军 」", 10, 44, 400, 12, C'180,160,100', 10);
      Label("Symbol", _Symbol, 10, 60, 80, 12, clrSilver, 9);
      Label("Magic", "Magic " + IntegerToString(InpMagicNumber), 100, 60, 120, 12, clrSilver, 9);
      Label("Period", "周期 M" + IntegerToString(Period() / 60), 200, 60, 80, 12, clrSilver, 9);
      Label("Status", "战况: 允许交易", 300, 60, 110, 12, clrLimeGreen, 9);
      
      int ry = 84;
      Rect("ProfitBG", 4, ry, m_w - 8, 64, C'20,25,20', C'60,70,50');
      Label("TodayLbl", "今日斩获", 12, ry + 4, 70, 14, C'180,160,100', 9);
      Label("TodayVal", "0.00", 12, ry + 22, 120, 26, clrLimeGreen, 16);
      Label("YestLbl", "昨日斩获", 140, ry + 4, 70, 14, C'180,160,100', 9);
      Label("YestVal", "0.00", 140, ry + 22, 120, 26, clrLimeGreen, 16);
      Label("TotalLbl", "累计斩获", 270, ry + 4, 70, 14, C'180,160,100', 9);
      Label("TotalVal", "0.00", 270, ry + 22, 140, 26, clrLimeGreen, 16);
      
      ry += 70;
      Rect("AcctBG", 4, ry, m_w - 8, 92, C'20,20,25', C'50,50,60');
      Label("AcctTitle", "账户概览", 12, ry + 5, 90, 14, C'150,180,200', 10);
      Label("BalLbl", "余额", 12, ry + 26, 40, 12, clrSilver, 9);
      Label("BalVal", "--", 52, ry + 26, 110, 12, clrWhite, 9);
      Label("EqLbl", "净值", 170, ry + 26, 40, 12, clrSilver, 9);
      Label("EqVal", "--", 206, ry + 26, 110, 12, clrWhite, 9);
      Label("MarLbl", "可用保证金", 12, ry + 44, 80, 12, clrSilver, 9);
      Label("MarVal", "--", 92, ry + 44, 80, 12, clrWhite, 9);
      Label("MargPLbl", "保证金比例", 170, ry + 44, 70, 12, clrSilver, 9);
      Label("MargPVal", "--", 242, ry + 44, 100, 12, clrWhite, 9);
      Label("FreeLbl", "已用保证金", 12, ry + 62, 80, 12, clrSilver, 9);
      Label("FreeVal", "--", 92, ry + 62, 80, 12, clrWhite, 9);
      Label("LevLbl", "杠杆", 170, ry + 62, 40, 12, clrSilver, 9);
      Label("LevVal", "--", 206, ry + 62, 80, 12, clrWhite, 9);
      Label("TradeCntLbl", "交易次数", 290, ry + 26, 60, 12, clrSilver, 9);
      Label("TradeCntVal", "0", 350, ry + 26, 60, 12, clrWhite, 9);
      Label("WinRateLbl", "胜率", 290, ry + 44, 40, 12, clrSilver, 9);
      Label("WinRateVal", "--", 350, ry + 44, 60, 12, clrWhite, 9);
      Label("PFLLbl", "盈亏比", 290, ry + 62, 40, 12, clrSilver, 9);
      Label("PFLVal", "--", 350, ry + 62, 60, 12, clrWhite, 9);
      
      ry += 98;
      Rect("PosBG", 4, ry, m_w - 8, 100, C'25,20,20', C'60,50,50');
      Label("PosTitle", "持仓监控", 12, ry + 5, 90, 14, C'200,150,150', 10);
      Label("BuyLbl", "多单", 12, ry + 26, 30, 12, clrSilver, 9);
      Label("BuyVal", "0单/0.00手", 42, ry + 26, 100, 12, clrWhite, 9);
      Label("BuyPL", "0.00", 150, ry + 26, 80, 12, clrLimeGreen, 9);
      Label("BuyAvgLbl", "均价", 240, ry + 26, 30, 12, clrSilver, 9);
      Label("BuyAvgVal", "--", 272, ry + 26, 140, 12, clrWhite, 9);
      
      Label("SellLbl", "空单", 12, ry + 46, 30, 12, clrSilver, 9);
      Label("SellVal", "0单/0.00手", 42, ry + 46, 100, 12, clrWhite, 9);
      Label("SellPL", "0.00", 150, ry + 46, 80, 12, clrRed, 9);
      Label("SellAvgLbl", "均价", 240, ry + 46, 30, 12, clrSilver, 9);
      Label("SellAvgVal", "--", 272, ry + 46, 140, 12, clrWhite, 9);
      
      Label("TotalPLLbl", "总浮盈亏", 12, ry + 66, 60, 12, clrSilver, 9);
      Label("TotalPLVal", "0.00", 72, ry + 66, 90, 12, clrWhite, 10);
      Label("TotalLots", "0.00手", 170, ry + 66, 70, 12, clrWhite, 10);
      Label("NetPLbl", "净盈亏", 250, ry + 66, 40, 12, clrSilver, 9);
      Label("NetPVal", "0.00", 292, ry + 66, 100, 12, clrWhite, 10);
      
      Label("BuyPeakLbl", "多峰值", 12, ry + 84, 50, 12, C'180,140,140', 8);
      Label("BuyPeakVal", "0.00", 62, ry + 84, 80, 12, C'200,160,160', 8);
      Label("SellPeakLbl", "空峰值", 150, ry + 84, 50, 12, C'180,140,140', 8);
      Label("SellPeakVal", "0.00", 200, ry + 84, 80, 12, C'200,160,160', 8);
      Label("NetPeakLbl", "净峰值", 290, ry + 84, 50, 12, C'180,140,140', 8);
      Label("NetPeakVal", "0.00", 340, ry + 84, 70, 12, C'200,160,160', 8);
      
      ry += 106;
      Rect("HedgeBG", 4, ry, m_w - 8, 82, C'20,25,20', C'50,60,50');
      Label("HedgeTitle", "多核对冲 · 移动止盈战法", 12, ry + 5, 220, 14, C'150,200,150', 10);
      Label("HedgeType", GetCloseModeName(), 280, ry + 5, 130, 14, C'150,200,180', 9);
      Label("HedgeBuy", "多单对冲: 待触发", 12, ry + 26, 180, 12, clrSilver, 9);
      Label("HedgeSell", "空单对冲: 待触发", 200, ry + 26, 180, 12, clrSilver, 9);
      Label("HedgeNet", "净盈亏对冲: 待触发", 12, ry + 44, 200, 12, clrSilver, 9);
      Label("TrailType", "止盈: " + GetTrailingTypeName(), 200, ry + 44, 200, 12, C'150,200,150', 9);
      Label("HedgeRule", "兵法: 盈 " + DoubleToString(InpHedgeStartPL, 1) + " / 撤 " + 
             ...
             12, ry + 62, 400, 12, C'150,170,150', 8);
      
      ry += 88;
      Rect("AddBG", 4, ry, m_w - 8, 74, C'22,22,28', C'55,50,60');
      Label("AddTitle", "加仓监控", 12, ry + 5, 90, 14, C'200,180,140', 10);
      Label("AddTypeLbl", "方式", 12, ry + 26, 30, 12, clrSilver, 9);
      Label("AddTypeVal", GetAddTypeName(), 42, ry + 26, 120, 12, clrWhite, 9);
      Label("AddDirLbl", "方向", 170, ry + 26, 30, 12, clrSilver, 9);
      Label("AddDirVal", GetAddDirName(), 202, ry + 26, 80, 12, clrWhite, 9);
      Label("AddCountLbl", "多/空层数", 290, ry + 26, 60, 12, clrSilver, 9);
      Label("AddCountVal", "0/0", 352, ry + 26, 60, 12, clrWhite, 9);
      Label("MaxLotLbl", "最大手", 12, ry + 46, 50, 12, clrSilver, 9);
      Label("MaxLotVal", DoubleToString(InpMaxAddLot, 2), 62, ry + 46, 60, 12, clrWhite, 9);
      Label("MaxTotLbl", "总手限", 130, ry + 46, 50, 12, clrSilver, 9);
      Label("MaxTotVal", DoubleToString(InpMaxTotalLot, 2), 182, ry + 46, 60, 12, clrWhite, 9);
      Label("MaxAddLbl", "最大层数", 250, ry + 46, 60, 12, clrSilver, 9);
      Label("MaxAddVal", IntegerToString(InpMaxAddCount), 312, ry + 46, 40, 12, clrWhite, 9);
      Label("SpacingLbl", "间距", 360, ry + 46, 30, 12, clrSilver, 9);
      Label("SpacingVal", GetSpacingName(), 392, ry + 46, 50, 12, clrWhite, 9);
      
      ry += 80;
      Rect("RiskBG", 4, ry, m_w - 8, 68, C'30,20,20', C'70,40,40');
      Label("RiskTitle", "风控师令 · 全军安危", 12, ry + 5, 180, 14, C'200,150,150', 10);
      Label("RiskFloat", "全单浮盈亏: 0.00", 12, ry + 26, 150, 12, clrWhite, 9);
      Label("RiskDD", "回撤: 0.00", 170, ry + 26, 110, 12, clrWhite, 9);
      Label("RiskDDPct", "0.00%", 290, ry + 26, 80, 12, clrWhite, 9);
      Label("RiskMode", "模式: " + GetModeName(), 370, ry + 26, 60, 12, C'200,170,170', 8);
      Label("RiskTrail", "移动止盈: " + IntegerToString(InpTrailActive) + "/" + IntegerToString(InpTrailLock) +
             " / 保本: " + IntegerToString(InpBreakevenDist),
             12, ry + 46, 380, 12, C'180,140,140', 8);
      
      Rect("FooterBG", 0, m_h - 28, m_w, 28, C'30,25,20', C'80,70,40');
      Label("Footer", "金戈铁马 · 铁骑托管中 · 多核对冲风控执行 · 请勿混用同Magic", 
            10, m_h - 22, 400, 14, C'180,160,100', 9);
   }
