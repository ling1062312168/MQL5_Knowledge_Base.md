...
void RenderAccountKPI() {
   ...
   SetRect("20019",x3+3,yLbl,w3-4,22,CLR_ALT_ROW,CLR_FRAME, 1);
   SetLabel("2001A","保证金 $"+DoubleToString(AccountMargin(),2),8,PANEL_FONT_B,CLR_TEXT_WARN,x3+6,yLbl+5);
   SetRect("2001C",x4+3,yLbl,w4-4,22,CLR_ALT_ROW,CLR_FRAME, 1);
   ...
   SetRect("2001F",x5+3,yLbl,w5-4,22,CLR_ALT_ROW,CLR_FRAME, 1);
...
void RenderSignalMatrix() {
   ...
   for(gi=1;gi<=16;gi++) {
      ...
      SetRect(sid, cx, cy, 118, 40, bgC, CLR_FRAME, 1);      SetRect(sid+"s", cx, cy, 3, 40, sdC, sdC, 1);      SetLabel("211"+DoubleToString(gi,0),"G"+DoubleToString(gi,0)+" "+g_GC_sym1[gi],7,PANEL_FONT_B,tC,cx+5,cy+2);
